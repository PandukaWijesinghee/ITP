...
const PropertyDash = () => {
    ...
    const fetchDetails = async () => {
        try {
            ...
            const filteredPosts = response.data.filter(post => post.email === sessionStorage.getItem('admin_name'));                        
            ...
            <div style={{ flexGrow: 1, padding: 20, backgroundColor: '#ecf0f1', display: 'flex', flexDirection: 'column' }}>
                <AppBar position="static" sx={{ backgroundColor: '#1c2331', boxShadow: 'none' }}>
                    <Toolbar>
                        ...
                        <Button variant="contained" color="primary" component={NavLink} to="/addProperty">
                            Add New Property
                        </Button>
                    </Toolbar>
                </AppBar>
